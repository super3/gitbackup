<template>
	<div>
		<div class="text-center mb-4">
			...
			<p>We backup and archive <a href="https://github.com">GitHub</a>. Currently tracking <span v-if="stats">{{stats.total.tolocalestring()}}</span> users/orgs.</p>
		</div>
		...
		<p class="mt-5 mb-3 text-muted text-center">
			...
			<span v-if="stats">{{stats.bytesPerMinute}}/min, {{stats.reposPerMinute}} repos/min, {{stats.usersPerMinute.tolocalestring()}} users/min<br></span>

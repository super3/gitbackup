...
test('encode', async () => {
	expect(pathing.encode('montyanderson')).toBe(`us-central-1:${pathing.bucket}/bc/be/22/6e/montyanderson`);
	expect(pathing.encode('calebcase')).toBe(`europe-west-1:${pathing.bucket}/70/d1/ea/99/calebcase`);
});
